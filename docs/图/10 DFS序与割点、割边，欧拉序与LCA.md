...
![img](../assets/images/22a2bdadf47c236e0f7dc420fa12520d.png)
...
![img](../assets/images/abffb792aba1fc2c84a4470683e4d3c5.png)
...
![img](../assets/images/04db1be1a9f49930f40a9590bb4cd334.png)
...
![img](../assets/images/44baaf3ced9d40e435f04dac86d93f64.png)

`dfs`与时间戳的关系，对应列表中索引号和值的关系。

![img](../assets/images/e6c6887b36fd993274864b7a1d598478.png)
...
![img](../assets/images/e7a4dfb074ce1cb537828e4bfe58fe78.png)
...
![img](../assets/images/324c81e2f6adb0025dab220d23fca7ad.png)
...
![img](../assets/images/66fcd32c56f560815f584d326373f150.png)
...
![img](../assets/images/22170f887edaef9d000cb86525e86fd2.png)
...
![img](../assets/images/fa7bde6196c7f422027774dd6a1d2a4e.png)

- 继续更新`5、6`号节点的`low`值。

![img](../assets/images/5e8c4984abc8f77c8d99fe8cf8832d4a.png)
...
![img](../assets/images/6f519c0c31100121cd553735091c840d.png)

删除`2-5`和`5-6`边后。

![img](../assets/images/a6edc4b0680bdd7ee3e1cef2c9be1c72.png)
...
![img](../assets/images/0481a7ff93b8f6a9de31b1c1373d6e54.png)

![img](../assets/images/0597f6815a613694183d6d05cb107466.png)
...
![img](../assets/images/dc463613d43de0e1acf41850842ca543.png)

- 直观比较，知道`4`号节点是其`LCA`，特征是`9`和`6`之间深度最小的节点。

欧拉序求`LCA`，先求图的欧拉序、时间戳（可以记录进入和离开节点的时间）以及节点深度。有了这些信息，理论上足以求出任意两点的`LCA`。变成了典型的`RMQ`问题。

![img](../assets/images/1de3561db45b1c4f8ee48f97135b2338.png)

为了提升多次查询性能，可以使用`ST`表根据节点的深度缓存节点的信息。`j=0`时如下图所示。

![img](../assets/images/901282c828b2ace569d6b8993ecc02ae.png)

`j=1`表示区间长度为 `2`，值为区间长度为 `1`的两个子区间的深度值小的节点。

![img](../assets/images/ea9c3d452103822329c1188eac1f118a.png)
