...
因为`cout`底层逻辑在输出字符数组时，会以一个特定标识符`\0`为作为结束标志。`cout`在输出 `myStr`字符数组的数据时，如果没有遇到开发者提供的`\0`结束符号，则会在数组的存储范围之外寻找`\0`符号。
...
![img](../assets/images/06d1153e180f3fa510a6f70b276b1b30.png)
...
![img](../assets/images/36e13805aa6c816862229c1e470bb3db.png)
...
![img](../assets/images/5dddd2a27aee3f9708f83089ecfe339d.png)
...
![img](../assets/images/3402255271bc01ffa23e5adb68501300.png)
...
![img](../assets/images/91545a593138d4f026cb80f6b7812af5.png)
...
本文主要讲解了`C++`字符串的2种存储方案，一个是`C`语言风格的数组存储方案，一个是`C++`对象存储方案。
