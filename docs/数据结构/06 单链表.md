...
![img](../assets/images/c0fd2d4fec6af588d586004d8d78da12.png)
...
![img](../assets/images/f23087106d71db93187ef28117265a90.png)
...
![img](../assets/images/9181cba5c629eae51df954a5c2b520cf.png)
...
![img](../assets/images/e08688073c7e502dc4a0d770b40957cb.png)
...
![img](../assets/images/b39e5579c863f77e6266c1395f9d17ec.png)
...
![img](../assets/images/7d3ffba0fddb44842490c4c88b4ed81b.png)

从结果可知，输入顺序和输出顺序是相反的。

- 尾部插入创建单链表，创建时的新结点替换原来的尾结点。如构建数据为`{4,9,12,7}`的单链表。

![img](../assets/images/9e206e8cd2ab18fda9572b7cdd617079.png)
...
![img](../assets/images/751c06f872f9895686d8174f9cec86bc.png)
...
![img](../assets/images/ad182e693586763cd8fd18b49d21f0f5.png)

后续再创建新结点后，`head`则不需修改，通用逻辑是：原来的尾结点成为新结点的前驱结点，新创建的结点成为新的尾结点。

![img](../assets/images/12baf3b8233a9beb9cffe7625d7a7741.png)
...
![img](../assets/images/88b93497d892b38644230c2d2a41b1f0.png)
...
- ![img](../assets/images/d5397057a38c96e2c1d127058045b497.png)
...
- ![img](../assets/images/5addb6e67c0262fbac5355e5006b5513.png)
...
![img](../assets/images/35987345ce7e472dc664e2199eb56c37.png)

#### 2.4.2 前插入

所谓前插入，指新结点插入到某个已知结点的前面。如下图所示：

![img](../assets/images/f2d8b7a4b5ad86acdbade652e2c5840c.png)

如果把新结点`n`插入到已知结点`p`的前面，则称为前插入。前插入的通用逻辑：

- 除了要查找到`p`结点在链表中的地址，还需要知道`p`结点的前驱结点`p1`的地址。

![img](../assets/images/c6f037eb37617debb3432afed7b80870.png)

- 创建新结点，然后指定新结点`n`的后驱结点为`p`结点。

![img](../assets/images/c3ba3a027a4c4d9df24782f5e0145a16.png)

- 指定结点`p1`的后驱结点为新结点`n`。

![img](../assets/images/1da8850a1d5f6300ae06e8a7d32b022a.png)
...
![img](../assets/images/9ea59e06947706231a3a16df0b159a33.png)
...
![img](../assets/images/b63635aa563f309087dc3b0d8707695d.png)

- 找到`p`结点的前驱结点`p1`。

![img](../assets/images/afafd5347be93c0ee1b444bf2c817bbb.png)
...
![img](../assets/images/f9a4b6390c6e15cb52df451c69ae060f.png)
...
![img](../assets/images/442d7c62ca211a4ebdf9b29ebf5decc6.png)
...
![img](../assets/images/a962d9aa83c6c0c8060d74109aae1c45.png)
