...
![img](../assets/images/1962a0aea90a05104efafc357b64f0fb.png)
...
如果一棵树没有任何节点，则称此树为空树。如果树不为空，则此树存在唯一的根节点`（root）`，根节点是整棵树的起点，其特殊之处在于没有前驱节点。如上图值为`董事长`的节点。
...
![img](../assets/images/8d05876ff3548aab275695ec3ea27092.png)



可以理解为`T1`和`T2`子树组成。

![img](../assets/images/5bc2c87bf49db28aad85776c6bd61514.png)
...
![img](../assets/images/0200bc65d1ffd3b143f9779815eef583.png)
...
![img](../assets/images/db3f6318a20247d5327726a13d0b0fab.png)



- 创建一个`11X11`的名为 `arrTree`的矩阵 ，行和列的编号对应节点的编号，并初始矩阵的值都为 `0`。

![img](../assets/images/bbd9c5cdf0c5e8d8e4146d4b641c9c85.png)



- 在树结构中，编号为 `1` 的节点和编号为`2、3`的节点存在父子关系，则把矩阵的 `arrTree[1][2]`和 `arrTree[1][3]`的位置设置为`1`。也就是说，行号和列号交叉位置的值如果是 `1` ，则标志着编号和行号、列号相同的节点之间有关系。

![img](../assets/images/8c9af1fb04ab1698cdf4d532be5366c5.png)



- 找到树中所有结点之间的关系，最后矩阵中的信息如下图所示。

![img](../assets/images/bfe543a0342359d5e8f92deabbae39fc.png)
...
![img](../assets/images/8f654f574c378f2ec718ec893e662d5e.png)
...
![img](../assets/images/423920cbe70cf4d25e58786f725fc331.png)
...
![img](../assets/images/9d900f380174f329bf2847f32b0827be.png)



如下文所示的树结构，用双亲表示法思路存储树结构后的物理结构如下图所示。

![img](../assets/images/41ca7c1026129af5219de6b36ffc4ff3.png)
...
![img](../assets/images/c4a410bcc728bd6b4ec0c08f5d6e6978.png)
...
![img](../assets/images/264e12594cf7837a0ec6a9a788849662.png)
...
![img](../assets/images/fda5adff8f95da9f6a1bdbd5cd2710cc.png)
...
![img](../assets/images/27806f4ef45e46b091c3121d7747bd73.png)



![img](../assets/images/4bb16da20d2e53acdde964974fe1480b.jpg)
